...
- 内置审计：匹配 279，缩放匹配 58，高置信待复核 103。
- 二次复核：已确认 103，未确认 0。
- 复核范围：solve v12 当前 CSV/JSON、双运行比较、原始输入派生的 Q1 朴素基线。旧 paper 图表未作为证据。
...
|`4.218017\times10^8`|sections/model_solution.tex|verified|data/q2_named_scheme_comparison.csv:cost_CNY; direct; scientific rounded 6 digits; evidence value=-421801700|
...
|`0.185976`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 6dp; evidence value=0.185976|
|`0.188133`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_candidate; direct; rounded 6dp; evidence value=0.188133|
|`-0.002157`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=-0.002157|
|`0.185976`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 6dp; evidence value=0.185976|
|`0.188231`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_candidate; direct; rounded 6dp; evidence value=0.188231|
|`-0.002255`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=-0.002255|
...
|`308.572069`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_candidate; direct; rounded 6dp; evidence value=308.572069|
|`-250.496713`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=-250.496713|
|`58.075356`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 6dp; evidence value=58.075356|
...
|`57.974066`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=57.974066|
|`0.101290`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 5dp; evidence value=0.10129|
|`-0.002619`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=-0.002619|
|`0.101290`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 5dp; evidence value=0.10129|
|`0.101485`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_candidate; direct; rounded 6dp; evidence value=0.101485|
|`-0.000194`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=-0.000194|
...
|`8.213862`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=8.213862|
|`294.820472`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 6dp; evidence value=294.820472|
|`294.820781`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_candidate; direct; rounded 6dp; evidence value=294.820781|
|`-0.000309`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; direct; rounded 6dp; evidence value=-0.000309|
|`294.820472`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_before; direct; rounded 6dp; evidence value=294.820472|
|`294.821904`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:joint_score_candidate; direct; rounded 6dp; evidence value=294.821904|
...
|`846`|sections/sensitivity.tex|identifier|SHA-256 identifier, not a quantitative claim|
|`527`|sections/sensitivity.tex|identifier|SHA-256 identifier, not a quantitative claim|
|`8365`|sections/sensitivity.tex|identifier|SHA-256 identifier, not a quantitative claim|
...
|`691`|sections/sensitivity.tex|identifier|SHA-256 identifier, not a quantitative claim|
|`0450`|sections/sensitivity.tex|identifier|SHA-256 identifier, not a quantitative claim|
...
|`1568.882`|sections/sensitivity.tex|verified|data/q3_search_trace.csv:equivalent_full_cycles_sum; direct; rounded 3dp; evidence value=1568.882|
|`-0.001431`|sections/model_solution.tex|verified|data/q4_alternation_trace.csv:improvement; rounded 6dp from -0.0014311598731637|
|`619`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`806`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`7171`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`010134639386134`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`808`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`2323007`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`0468`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`55453`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|
|`949316`|sections/sensitivity.tex|identifier|SHA-256 identifier fragment, not a quantitative claim|

## 结论

内置审计的 103 个高置信待复核项全部完成出处确认；其中数值来自当前 solve v12 CSV/JSON、双运行证据或可复算派生，哈希片段与逗号分隔滞后列表属于解析器误识别。未确认数为 0。
